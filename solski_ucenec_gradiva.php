    ...
    <div class="dashboard-wrap">
        ...
        <div class="dashboard-grid">
            <?php if ($gradiva): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <div class="dashboard-card" style="border-radius: 20px; background: rgba(255, 255, 255, 0.6); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px);">Za izbrani predmet ni gradiv.</div>
            <?php endif; ?>
        </div>
    </div>
</body>
