...
<body>
    <div class="dashboard-wrap">
        ...
        <h1 class="dashboard-title" style="color: #ffffff; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.3);">Urejanje predmetov</h1>
        ...
        <div class="dashboard-card" style="overflow-x:auto; border-radius: 20px; background: rgba(255, 255, 255, 0.6); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px);">
